...
filename=""
clear
read -p "Input the file name you want to monitor:" filename
...
echo -e "The size of [$filename] is $filesize\n"
...
do
        ...
        then
                ...
                then
                        echo "Test exceed $file_nochange_times times"
                        clear;exit
                fi
        fi     
done
